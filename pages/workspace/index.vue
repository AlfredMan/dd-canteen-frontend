            ...
            <div class="col-12 col-md-8">
              <div class="row d-flex align-items-end justify-content-end">
                <div class="col-12 col-md-7">
                  <img src="http://images.ctfassets.net/7p1ysxjarsp5/1eLvovl1dCbtnZvQ5f7EEM/09e2e8afdb9cefe11c793ce446ee7e50/KDN_Design_District_C1_190603_LR.jpeg?w=1000&h=1200&fm=webp&q=80&fit=thumb" alt="">
                </div>
              </div>
            </div>
          </div> -->
          ...
          <div class="row">
            ...
            <div class="col-12 row d-flex justify-content-start">
              <div class="col-12 col-md mb-3">
                ...
                <div class="">
                  <div class="btn btn-outline-dark chip mr-2 mb-2">
                    1
                  </div>
                  <div class="btn btn-outline-dark chip mr-2 mb-2">
                    2–4
                  ...
                  <div class="btn btn-outline-dark chip mb-2">
                    30+
                  </div>
                </div>
              </div>
