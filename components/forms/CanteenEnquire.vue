...
<div class="container"> -->
  <div class="">
    <div v-if="formState === 'complete'">
      ...
      <p>
        We'll be in touch soon. Meanwhile, follow our
        <a
          href="https://www.instagram.com/designdistrictlondon/"
          target="_blank"
          rel="noreferrer"
          >Instagram</a
        >
    ...
    >
            ...
            <div class="col-12 col-md-12">
              <div class="checkbox-wrapper">
                ...
                <label class="cb" for="enquirePrivacyOptIn">
                  <span
                    >I would like to sign-up to receive regular news and updates
                    from Design District. See our
                    <a target="_blank" href="/privacy-notice">Privacy Notice</a>
                    and
                    <a target="_blank" href="/cookies-policy/">Cookie Policy</a
                    >.</span
                  >
                </label>
              </div>
              <div class="checkbox-wrapper">
                ...
                <label class="cb" for="enquireMarketingOptIn">
                  <span>
                    Keep me up to date about the latest news and events at
                    Greenwich Peninsula
      ...
      <div v-if="showBusiness" v-show="step === 2" class="my-4 mt-5">
        ...
        <div class="form-row">
          ...
          <div
            v-show="arrayIncludesString(roleType, 'Other')"
            class="col-12 col-md-6"
          >
            <label class="-accessible-hide" for="00N3Y00000H10Cj"
              >Please specify your role</label
            >
            <input
              id="00N3Y00000H10Cj"
              ref="00N3Y00000H10Cj"
        ...
        <div class="form-row"> -->
          <div class="col-12 col-md-6">
            ...
            >
              ...
              <option
                value="IT, software, computer services and UX Design(‘creative tech’)"
              >
          ...
          <div
            v-show="arrayIncludesString(industry, 'Other')"
            class="col-12 col-md-6"
          >
        ...
        <div class="form-row">
          <div class="col-12 col-md-12">
            ...
            <textarea
              id="00N0O00000AAmP4"
              name="00N0O00000AAmP4"
              rows="4"
              class="input-text form-field-reset"
              placeholder="Describe your business in 250 words"
            />
          </div>
        </div>
      </div>
      ...
      <div v-show="step === 2" class="my-4">
        <div class="form-row">
          ...
          <div v-show="typeOfSpace === 'Other'" class="col-12 col-md-6">
            <label for="00N0O00000AAoDP"
              >Please specify the type of space</label
            >
            <input
              id="00N0O00000AAoDP"
              ref="00N0O00000AAoDP"
        ...
        <div class="my-4">
          <label for=""
            >What services and amenities are important to you ?</label
          >
        ...
        <div class="form-row">
          ...
          <div
            v-show="arrayIncludesString(reasonOfMove, 'Other')"
            class="col-12 col-md-6"
          >
      ...
      <input
        ...
        ref="00N0O00000AB5iY"
        type="hidden"
        name="00N0O00000AB5iY"
        value="Design District Sales Enquiry"
      />
      <input
        id="00N0O00000AB5iN"
        ref="00N0O00000AB5iN"
        type="hidden"
        name="00N0O00000AB5iN"
        value="7010O00000153FNQAY"
      />
      <input
        id="enquireDesignOptInDate"
        ref="enquireDesignOptInDate"
        type="hidden"
        name="00N0O00000GRkIf"
        value=""
      />
      <input
        id="enquireMarketingOptInDate"
        ref="enquireMarketingOptInDate"
        type="hidden"
        name="00N0O00000GRZbC"
        value=""
      />
      <input
        id="enquirePrivacyOptInDate"
        ref="enquirePrivacyOptInDate"
        type="hidden"
        name="00N0O00000GRrXh"
        value=""
      />
      ...
      <input
        id="00N3Y00000H1cZf"
        ref="Last_Page_Viewed"
        type="hidden"
        name="00N3Y00000H1cZf"
        value=""
      />
      <input
        ref="tracking"
...
export default {
  ...
  methods: {
    ...
    onVerify(recaptchaToken) {
      ...
      this.resetRecaptcha();
      const url =
        "https://us-central1-designdistrict-2b9e1.cloudfunctions.net/verify";
    ...
    submitEnquireForm() {
      ...
      if (
        ...
        this.$refs.first_name.value.toLowerCase() == "test 123"
      ) {
      ...
      if (
        this.$refs.first_name.value &&
        this.$refs.first_name.value.toLowerCase() == "james" &&
        this.$refs.last_name.value &&
        this.$refs.last_name.value.toLowerCase() == "smith"
      ) {
        alert("Sorry, something went wrong!");
        this.resetForm();
        return false;
