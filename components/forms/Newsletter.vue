<template>
  <div class="">
    ...
    <form action="https://webto.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" name="subscribeForm" method="post">
      ...
      <input id="00N0O00000AB5iY" type="hidden" name="00N0O00000AB5iY" value="Design District Subscription">
      <input id="00N0O00000AB5iN" type="hidden" name="00N0O00000AB5iN" value="7010O00000153NQQAY">
      <input id="designOptInDate" type="hidden" name="00N0O00000GRkIf" value="">
      <input id="marketingOptInDate" type="hidden" name="00N0O00000GRZbC" value="">
      <input id="privacyOptIn" type="hidden" name="00N0O00000GRrXc" value="1">
      <input id="privacyOptInDate" type="hidden" name="00N0O00000GRrXh" value="">
      ...
      <div v-show="active" class="">
        ...
        <div>
          <input id="designOptIn" class="form-field-reset checkbox" type="checkbox" name="00N0O00000GRkIa" value="1">
        ...
        <div>
          <input id="marketingOptIn" class="form-field-reset checkbox" type="checkbox" name="00N0O00000GRZb7" value="1">
      ...
      <div v-show="active" class="form-group form-submit">
