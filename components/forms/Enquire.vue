  ...
  <div class="">
    <form class="page-form" action="https://webto.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" name="enquireForm" method="post">
      ...
      <div v-if="showBusiness" class="">
        ...
        <div class="form-row">
          <div class="col-6 full">
            ...
            <textarea name="00N0O00000AAdtr" rows="6" class="input-text form-field-reset" placeholder="Describe your business" />
          </div>
        </div>
      </div>
      ...
      <div class="form-row mb-5">
        <div class="col-12 col-md-6">
          <select id="typeOfSpace" class="custom-select form-control form-field-reset" name="00N0O00000AAdth" required>
          ...
          <div class="row">
            <div class="col-12 col-lg">
              <div class="checkbox-wrapper">
                <input id="00N0O00000AAmWy" class="form-field-reset checkbox" type="checkbox" name="00N0O00000AAmWy" value="1">
                <label for="00N0O00000AAmWy">
                  <span>High-speed internet</span>
                </label>
              </div>
              <div class="checkbox checkbox--wide">
                <input id="00N0O00000AAmX3" class="form-field-reset checkbox" type="checkbox" name="00N0O00000AAmX3" value="1">
                <label for="00N0O00000AAmX3">
                  <span>Printing (including 3D, canvas, vinyl)</span>
                </label>
              </div>
              <div class="checkbox-wrapper">
                <input id="00N0O00000AAmXh" class="form-field-reset checkbox" type="checkbox" name="00N0O00000AAmXh" value="1">
            ...
            <div class="col-12 col-lg">
              <div class="checkbox-wrapper">
                <input id="00N0O00000AAmX8" class="form-field-reset checkbox" type="checkbox" name="00N0O00000AAmX8" value="1">
                <label for="00N0O00000AAmX8">
                  <span>Private phone booths</span>
                </label>
              </div>
              <div class="checkbox checkbox--wide">
                <input id="00N0O00000AAmXN" class="form-field-reset checkbox" type="checkbox" name="00N0O00000AAmXN" value="1">
                <label for="00N0O00000AAmXN">
                  <span>Meeting rooms with AV</span>
                </label>
              </div>
              <div class="checkbox-wrapper">
                <input id="00N0O00000AAmXI" class="form-field-reset checkbox" type="checkbox" name="00N0O00000AAmXI" value="1">
            ...
            <div class="col-12 col-lg">
              <div class="checkbox-wrapper">
                <input id="00N0O00000AAmXc" class="form-field-reset checkbox" type="checkbox" name="00N0O00000AAmXc" value="1">
                <label for="00N0O00000AAmXc">
                  <span>Event space</span>
                </label>
              </div>
              <div class="checkbox checkbox--wide">
                <input id="00N0O00000AAmXS" class="form-field-reset checkbox" type="checkbox" name="00N0O00000AAmXS" value="1">
                <label for="00N0O00000AAmXS">
                  <span>Access to multiple office locations</span>
                </label>
              </div>
              <div class="checkbox-wrapper">
                <input id="00N0O00000AAmXD" class="form-field-reset checkbox" type="checkbox" name="00N0O00000AAmXD" value="1">
      ...
      <div class="">
        ...
        <div class="form-row mb-5">
          <div class="col-12 col-md-6">
            <select id="00N0O00000AAdtw" class="custom-select form-control form-field-reset" name="00N0O00000AAdtw">
              <option value="" disabled selected>
                -
              </option>
      ...
      <div class="">
        ...
        <div class="form-row mb-5">
          <div class="col-12 col-md-8">
            ...
            <div class="checkbox-wrapper">
              <input id="enquireDesignOptIn" class="form-field-reset checkbox" type="checkbox" name="00N0O00000GRkIa" value="1">
            ...
            <div class="checkbox-wrapper">
              <input id="enquireMarketingOptIn" class="form-field-reset checkbox" type="checkbox" name="00N0O00000GRZb7" value="1">
      ...
      <input id="00N0O00000AB5j2" type="hidden" name="00N0O00000AB5j2" value="Web Form">
      <input id="00N0O00000AB5j1" type="hidden" name="00N0O00000AB5j1" value="Design District">
      <input id="00N0O00000AB5iY" type="hidden" name="00N0O00000AB5iY" value="Design District Sales Enquiry">
      <input id="00N0O00000AB5iN" type="hidden" name="00N0O00000AB5iN" value="7010O00000153FNQAY">
      <input id="enquireDesignOptInDate" type="hidden" name="00N0O00000GRkIf" value="">
      <input id="enquireMarketingOptInDate" type="hidden" name="00N0O00000GRZbC" value="">
      <input id="enquirePrivacyOptInDate" type="hidden" name="00N0O00000GRrXh" value="">

      <input id="00N0O00000AB5iO" type="hidden" name="00N0O00000AB5iO" value="">
      <input id="00N0O00000AB5iQ" type="hidden" name="00N0O00000AB5iQ" value="">
      <input id="utm_source" type="hidden" name="00N0O00000AB5iR" value="">
      <input id="utm_term" type="hidden" name="00N0O00000AB5iS" value="">
      <input id="utm_content" type="hidden" name="00N0O00000AB5iP" value="">

      <div class="form-row form-row--submit">
        <button onclick="submitEnquireForm(); return false;" class="btn btn-primary btn-lg">
          Submit
        </button>
