...
export default {
  ...
  mounted() {
    ...
    this.draggable = Draggable.create(".app-map-panel", {
      ...
      // autoScroll: 2
      // liveSnap: {
      //   // points: [{ x:self.containerWidth / 2, y: -(clientHeight / 2) }],
      //   points: [
      //     { x:self.containerWidth / 2, y: 0 },
      //     { x:self.containerWidth / 2, y: -self.containerHeight / 2 }
      //   ],
      //   radius: 250
      // }
    });
  ...
  methods: {
    ...
    resetPanelHeightAndBound(currentPanelY) {
      ...
      draggable.applyBounds(newBound);
      // .bounds.height = newInfoPanelHeight * 2;
