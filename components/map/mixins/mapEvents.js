  ...
  methods: {
    ...
    bindEvents () {
      if (process.client) {
        ...
        // self.sceneState.container.addEventListener('resize', self.onWindowResize, false)
    ...
    unbindEvents () {
      if (process.client) {
        ...
        // self.sceneState.container.removeEventListener('resize', self.onWindowResize, false)
