  ...
  head: {
    ...
    meta: [
      ...
      { property: "og:type", content: "website" },
      {
        property: "og:title",
        content:
          "Welcome to London's new Design District - Launching Summer 2021"
      },
      {
        property: "og:description",
        content:
          "London's permanent home for the creative industries — Rent a desk or an entire building and find a new way of working. With affordable spaces, comprehensive facilities and flexible leases, everything is designed to help creative Londoners thrive."
      },
...

      {
        ...
        content: "614c2k2scnq9kskjkj7x3oc61kx43t"
      }
    ],
    link: [
